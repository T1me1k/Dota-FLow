...
- Assessments for Roshan, Tormentor, towers, barracks, runes, Lotus, Outpost, high ground and map control.\n- Readiness checks use only supplied resources, cooldown, visible-enemy and team readiness data.
