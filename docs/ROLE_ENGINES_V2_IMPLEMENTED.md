# Role Engines v2 — implemented

Implemented in Dota Flow 0.20.0 as a deterministic, framework-independent core feature.

## Implemented

- Specialized strategy modules preserve a common role decision contract for all five positions.\n- The legacy stable coordinator remains compatible while v2 strategies are available for gradual adoption.
