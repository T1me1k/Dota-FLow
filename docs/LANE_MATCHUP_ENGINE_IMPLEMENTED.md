# Lane Matchup Engine — implemented

Implemented in Dota Flow 0.20.0 as a deterministic, framework-independent core feature.

## Implemented

- Role-aware carry, mid, offlane, position 4 and position 5 lane calls with normalized LaneState and per-field provenance.\n- Safe fallback prevents unverified rotations, tower pressure and lane abandonment.
