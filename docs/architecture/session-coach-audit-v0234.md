...
| Check-in result | DEMO_ONLY | Derived outside JSX from the saved user report; unknown context remains null |
...
| Daily reflection summary | PARTIAL | Form exists; richer persisted summary remains a known limitation |
