# Draft & Build Advisor v2 — implemented

Implemented in Dota Flow 0.20.0 as a deterministic, framework-independent core feature.

## Implemented

- Draft output exposes 29 ally/enemy dimensions and honest lane-matchup missing data.\n- AdaptiveBuildCoordinator adds cooldown, score margin and auditable plan-change history.
