# Personal Coach — implemented

Implemented in Dota Flow 0.20.0 as a deterministic, framework-independent core feature.

## Implemented

- Versioned local settings, BEGINNER/STANDARD/EXPERT presentation, in-memory provider for tests, persistence contract and review-derived learning profile.\n- Personalization changes priority and wording only, never match facts.
