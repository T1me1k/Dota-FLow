...
test('prepared Roshan call is rescored and cannot hide a reviewed critical RESET', () => {
  const call = orchestrateDecision({
    ...
    macroDecision: {
      ...
      profile: { calibrationVersion: 'review-required-7.41-faceless-void-conservative-v2' },
  ...
  assert.ok(call.confidence >= 0.54);
